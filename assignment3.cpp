...
/*
  ...
  When I project query points from to the reference image according to the estimated model
  they must be within a range of N pixels (N=RANSAC_threshold) with respect to the matching reference keypoints
  */
